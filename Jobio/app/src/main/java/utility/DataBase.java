...
public class DataBase {
    ...
    private static final String DATABASE_NAME = "dbJobio";
    private static final int DATABASE_VERSION = 1;

    public static final String module_flag_table = "ModuleFlag";
    public static final int module_Flag_int = 0;

    String[][] tables = new String[][]{{"localPKModuleId", "serverPKModuleId", "moduleName"},
    };
    private static final String TABLE_1_CREATE = "create table "
            + module_flag_table
            + "(localPKModuleId integer primary key autoincrement,"
            + "serverPKModuleId text not null,moduleName text not null);";
    ...
    public void cleanTable(int tableNo) {
        switch (tableNo) {
            case module_Flag_int:
                sqLiteDb.delete(module_flag_table, null, null);
                break;
/*		case LastVisitedSuburb_int:
            sqLiteDb.delete(LastVisitedSuburb_table, null, null);
			break;*/
            default:
                break;
        }
    ...
    public synchronized Cursor fetchCounts(String DATABASE_TABLE, int tableNo,
