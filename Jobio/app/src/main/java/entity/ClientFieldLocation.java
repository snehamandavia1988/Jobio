...
public class ClientFieldLocation {
    int id, userId, jobId;
    String reverseGeoCodeName, appType;
    MyLocation objMyLocation;

    public ClientFieldLocation(int id, int userId, int jobId, String reverseGeoCodeName, String appType, MyLocation objMyLocation) {
        this.id = id;
        this.userId = userId;
        this.jobId = jobId;
